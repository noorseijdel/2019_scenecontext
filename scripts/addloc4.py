...
for obj_dir in obj_dirs:
    ...
    for image in sub_dirs:
        ...
        for bg_im in os.listdir(os.path.join('/media/noor/DataNS/Imagesets/SUN/SUN2012/SUN2012', bg_atyp)):
            ...
            if not os.path.exists(os.path.join('/media/noor/DataNS/Imagesets/DNimal_I_background/humanstim/', image.split("/")[-2], image.split("/")[-1], 'a_background', 'loc4')):
                os.makedirs(os.path.join('/media/noor/DataNS/Imagesets/DNimal_I_background/humanstim/', image.split("/")[-2], image.split("/")[-1], 'a_background', 'loc4'))

            newfilename = os.path.join('/media/noor/DataNS/Imagesets/DNimal_I_background/humanstim/', image.split("/")[-2], image.split("/")[-1], 'a_background', 'loc4',bg_im)
            #print(bg_im)
        ...
        for bg_im in os.listdir(os.path.join('/media/noor/DataNS/Imagesets/SUN/SUN2012/SUN2012', bg_typ)):
            ...
            if not os.path.exists(os.path.join('/media/noor/DataNS/Imagesets/DNimal_I_background/humanstim/', image.split("/")[-2], image.split("/")[-1], 't_background', 'loc4')):
                os.makedirs(os.path.join('/media/noor/DataNS/Imagesets/DNimal_I_background/humanstim/', image.split("/")[-2], image.split("/")[-1], 't_background', 'loc4'))

            newfilename = os.path.join('/media/noor/DataNS/Imagesets/DNimal_I_background/humanstim/', image.split("/")[-2], image.split("/")[-1], 't_background', 'loc4',bg_im)
                #newfilename = newfilename.replace(".png/", "/")
            result.save(newfilename)
        ...
        if not os.path.exists(os.path.join('/media/noor/DataNS/Imagesets/DNimal_I_background/humanstim/', image.split("/")[-2], image.split("/")[-1], 'w_background', 'loc4')):
            os.makedirs(os.path.join('/media/noor/DataNS/Imagesets/DNimal_I_background/humanstim/', image.split("/")[-2], image.split("/")[-1], 'w_background', 'loc4'))

        newfilename = os.path.join('/media/noor/DataNS/Imagesets/DNimal_I_background/humanstim/', image.split("/")[-2], image.split("/")[-1], 'w_background', 'loc4',bg_im)
            #newfilename = newfilename.replace(".png/", "/")
        result.save(newfilename)
