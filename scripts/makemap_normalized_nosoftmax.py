...
catIDs = [628,633,638,651,652,704,725,743,762,766,780,783,815,818,847,893]
...
for condition in conditions:
    for resnet in resnets:
        ...
        for catID in catIDs:
            ...
            patched_file = '/media/noor/DataNS/Onderzoek/Projects/ResNetDepth_analysisfiles/Probability/patch128/'+resnet+'_'+ condition[0] + '_'+str(catID)+'_patch128_nosoftmax_logits.txt'
